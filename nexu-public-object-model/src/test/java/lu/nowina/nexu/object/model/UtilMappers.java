 ...
 * Util mappers.
 * 
 * <p>Methods do not need to be really implemented.
 *
...
public class UtilMappers {
	...
	public String mapByteArray(byte[] bytes) {
		return null;
	}
	
	public String mapCertificateToken(CertificateToken certificateToken) {
		return null;
	}
